...
Tags, open and done, author and time, optional photo, and the flag meaning the owner should be told now.
...
widths, `npm run check` green. Add a phase-specific list and state it in the report._
